...
Créer une organisation, c'est la première étape pour pouvoir publier tes ressources.
C'est aussi une possibilité pour toi que plusieurs personnes prennent soin de tes fiches, car tu peux inviter des membres à rejoindre ton organisation.
...
Voilà, tu utilises multiBàO comme visionneuse pour tes ressources personnelles!
Le plus, c'est que toutes les fonctionnalités de multiBàO sont ouvertes à tes ressources.
